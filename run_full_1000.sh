...
echo "Starting Teacher Forcing (Phase 1)..."
python3 run_experiment.py --phase generate --model Qwen/Qwen2.5-7B-Instruct --vllm-data experiment_output_7B_1000/vllm_raw_samples.json --output experiment_output_7B_1000 --n-prompts 1000 --n-samples 8 --max-tokens 512

echo "Starting DPO Training (Phase 2)..."
